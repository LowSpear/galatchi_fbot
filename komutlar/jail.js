...
exports.run = async(client, message, args) => {
   if(!message.member.roles.cache.has('808297888098287808297888098287616616')) return message.channel.send(new Discord.MessageEmbed().setColor("RED").setDescription(`**⚠️ • Bu Komutu Kullanabilmek İçin \`Jail Hammer\` Yetkisine Sahip Olman Lazım**`))
   ...
   let jail = message.guild.roles.cache.find(r => r.id === '850747491971366943')//JAİL ROL GİR
